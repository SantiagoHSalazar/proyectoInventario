...
tlsCAFile=ca)
        ...
        theClass = get_args(self. orig_bases [0])
        self.coleccion = theClass[0]. name .lower()
    ...
    def save(self, item: T):
        ...
        if hasattr(item, "_id") and item._id != "":
            ...
            _id = laColeccion.insert_one(item. dict )
            elId = _id.inserted_id. str ()
